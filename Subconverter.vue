  ...
  data() {
    return {
      ...
      options: {
        ...
        backendOptions: [{ value: "http://81.68.117.116:8080/sub?" }],
        remoteConfig: [
		{
			label: "ACL4SSR",
			options: [
			...
			{
				label: "ACL4SSR_Online_Full_AdblockPlus全规则去广告修改版",
				value: "https://github.com/dupc23/ACL4SSR_Online_Full_AdblockPlus/blob/main/ACL4SSR_Online_Full_AdblockPlus.ini"
			},
			{
